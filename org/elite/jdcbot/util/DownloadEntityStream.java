 ...
 * @version 0.1
 */
public class DownloadEntityStream extends OutputStream {
    ...
    public DownloadEntityStream(OutputStream out) {
	this(out, 0);
    }

    public DownloadEntityStream(OutputStream out, long total) {
	super();
	if (total == 0)
	    meter = new Meter();
	else
    ...
    public DownloadEntityStream(OutputStream out, long total, long transferLimit) {
	this(out, total);
